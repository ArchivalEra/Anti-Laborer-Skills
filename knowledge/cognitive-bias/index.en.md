...
name: Cognitive Biases and the Persuasion Mechanics of Anthropoid Lifecycle Control
type: DomainIndex
spec_version: "0.2"
status: active
...
concepts:
  - id: okf.knowledge.cognitive_bias.availability_heuristic
    file: availability-heuristic.en.md
    name: The Availability Heuristic and Peer-Comparison Anxiety Amplification
  - id: okf.knowledge.cognitive_bias.status_quo_loss_aversion
    file: status-quo-loss-aversion.en.md
    name: Status Quo Bias and Loss Aversion — Manufacturing Compliance with Age Norm Discourse
